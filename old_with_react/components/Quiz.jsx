...
export default function Quiz() {
  ...
  const generateResults = async (answersObj) => {
    setLoading(true);
    ...
    try {
      ...
      setError("Failed to generate your political matches. " + err.message);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="quiz-container" style={{ maxWidth: '800px', margin: '2rem auto', padding: '1rem' }}>
      
      {!isFinished && (
        <div className="quiz-card" style={{ padding: '2rem', backgroundColor: '#f9f9f9', borderRadius: '12px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
      ...
      {isFinished && loading && (
        <div style={{ textAlign: 'center', padding: '4rem' }}>
          ...
          <div className="spinner" style={{ marginTop: '2rem', fontSize: '2rem' }}>⚙️</div>
        </div>
      )}
